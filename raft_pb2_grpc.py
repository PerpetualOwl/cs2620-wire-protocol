...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReplicateLog = channel.unary_unary(
                '/raft.RaftService/ReplicateLog',
                request_serializer=raft__pb2.LogEntry.SerializeToString,
                response_deserializer=raft__pb2.ReplicationResponse.FromString,
                )
        self.RequestState = channel.unary_stream(
                '/raft.RaftService/RequestState',
                request_serializer=raft__pb2.StateRequest.SerializeToString,
                response_deserializer=raft__pb2.StateChunk.FromString,
                )
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReplicateLog': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=raft__pb2.ReplicationResponse.SerializeToString,
            ),
            'RequestState': grpc.unary_stream_rpc_method_handler(
                    servicer.RequestState,
                    request_deserializer=raft__pb2.StateRequest.FromString,
                    response_serializer=raft__pb2.StateChunk.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    def ReplicateLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raft.RaftService/ReplicateLog',
            raft__pb2.LogEntry.SerializeToString,
            raft__pb2.ReplicationResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RequestState(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/raft.RaftService/RequestState',
            raft__pb2.StateRequest.SerializeToString,
            raft__pb2.StateChunk.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
